...
class Predict:
    ...
    def createTransform_tf_idf(self, text):
        ...
        pickle.dump(X , open(r"IMDB_review\app\pickle\tf_idf.pickle" , "wb"))
        print(X.shape)
        return X
    ...
    def loadTransform_tf_idf(self, text):
        ...
        tf_idf = pickle.load(open(r"IMDB_review\app\pickle\tf_idf.pickle" , "rb"))
    ...
    def train_model(self, X, y):
        ...
        pickle.dump(xgb, open(r"IMDB_review\app\pickle\xgb.pickle", "wb"))
        

    def load_predict(self, X):
        xgb = pickle.load(open(r"IMDB_review\app\pickle\xgb.pickle", "rb"))
        y = xgb.predict(X)
        return y
